...
//!
//! This is the counterpart to `draw`: [`amoeba_rl::sim`] says *what*
//! happened, and everything here decides what that sounds like. The waveforms
//! themselves come from [`amoeba_rl::synth`], which stays macroquad-free
...
use amoeba_rl::sim::{Cue, InputFrame};
use amoeba_rl::synth;
